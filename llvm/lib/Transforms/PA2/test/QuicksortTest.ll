; ModuleID = 'QuicksortTest.cpp'
source_filename = "QuicksortTest.cpp"
...
@_ZZ4mainE3arr = private unnamed_addr constant [6 x i32] [i32 10, i32 7, i32 8, i32 9, i32 1, i32 5], align 16
@.str.1 = private unnamed_addr constant [16 x i8] c"Sorted array: \0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_QuicksortTest.cpp, i8* null }]
...
; Function Attrs: noinline nounwind optnone uwtable
define i32 @_Z9partitionPiii(i32*, i32, i32) #3 {
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
...
define void @_Z9quickSortPiii(i32*, i32, i32) #4 {
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; <label>:11:                                     ; preds = %3
  ...
  %19 = sub nsw i32 %18, 1
  call void @_Z9quickSortPiii(i32* %16, i32 %17, i32 %19)
  %20 = load i32*, i32** %4, align 8
  %21 = load i32, i32* %7, align 4
  %22 = add nsw i32 %21, 1
  %23 = load i32, i32* %6, align 4
  call void @_Z9quickSortPiii(i32* %20, i32 %22, i32 %23)
  br label %24
...
; Function Attrs: noinline optnone uwtable
define void @_Z10printArrayPii(i32*, i32) #4 {
  %3 = alloca i32*, align 8
...
define i32 @main() #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast ([6 x i32]* @_ZZ4mainE3arr to i8*), i64 24, i32 16, i1 false)
  store i32 6, i32* %3, align 4
  %5 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i32 0, i32 0
  %6 = load i32, i32* %3, align 4
  %7 = sub nsw i32 %6, 1
  call void @_Z9quickSortPiii(i32* %5, i32 0, i32 %7)
  %8 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0))
  %9 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i32 0, i32 0
  %10 = load i32, i32* %3, align 4
  call void @_Z10printArrayPii(i32* %9, i32 %10)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_QuicksortTest.cpp() #0 section ".text.startup" {
